...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    ...
    subheadline = "Virelia connects every call, chat, and meeting into a unified AI layer — delivering real-time insights, tone analysis, and team alignment across your favorite tools.",
    description = "Trusted by fast-growing teams and enterprises, Virelia powers smarter communication across 1,000+ organizations — with enterprise-grade security, multilingual analysis, and instant emotional detection.",
